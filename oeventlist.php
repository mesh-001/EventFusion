                ...
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            <a href="organizer.php" class="nav-item nav-link">Home</a>
                            <a href="participantsslist.php" class="nav-item nav-link ">Participants List</a>
                            <a href="oeventlist.php" class="nav-item nav-link active">Events List</a>
