...
<body><!-- Spinner Start -->
                ...
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="userslist.php" class="nav-item nav-link active">Users List</a>
                            <a href="eventslist.php" class="nav-item nav-link">Events List</a>
        ...
        <div class="container-fluid bg-light py-6 my-6 mt-0">
            <div class="container text-center animated bounceInDown">
                <h1 class="display-1 mb-4">Users List</h1>
                <ol class="breadcrumb justify-content-center mb-0 animated bounceInDown">
                    <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
                    <li class="breadcrumb-item text-dark" aria-current="userslist.php">User List</li>
                </ol>
            </div>
        </div>
        <!-- Hero End -->
                        ...
                        <div class="text-center">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    $rows = mysqli_query($conn, "SELECT * FROM register");
