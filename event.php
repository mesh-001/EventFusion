                ...
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="index.html" class="nav-item nav-link ">Connect</a>
                            <a href="book.html" class="nav-item nav-link">Booking</a>
                            <!--
                        ...
                        <a href="home.php" class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill"> 
                        <?php
                ...
                <div class="row g-0">
                    ...
                    <div class="col-10">
                        <div class="border-bottom border-top border-primary bg-light py-5 px-4">
                            ...
                            <form class="form form-addevent" method="POST" action="">
                            <div class="row g-4 form">
                                <div class="col-lg-4 col-md-6">
                                    <select class="form-select border-primary p-2" aria-label="Default select example" name="loc" id="loc">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <select class="form-select border-primary p-2" aria-label="Default select example" name="city" id="city">
                                        <option selected>Select City</option>
                                        <option name="city" value="Visakhapatnam">Visakhapatnam</option>
                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <select class="form-select border-primary p-2" aria-label="Default select example" name="place" id="place">
                                        <option selected>Select Place</option>
                                        <option name="place" value="India">India</option>
                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <select class="form-select border-primary p-2" aria-label="Default select example" name="cat" id="cat">
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-primary px-5 py-3 rounded-pill" value="Add Event" name="submit" id="submit">Submit</button>
                                </div>
                            </div>
                            </form>
                        </div>
...
if(isset($_POST['submit'])) {
    echo "Form Submitted";
    // Database connection
    $conn=  mysqli_connect('localhost', 'id21269171_mesh001', 'Event*Fusion001', 'id21269171_eventfusion');
    ...
    $sql = "INSERT INTO eventlist (Location, City, Place, Category, People, Cost, Contact, Date, Email) VALUES ('$loc','$city', '$place', '$cat', '$people', '$cost', '$phno', '$date', '$email')";
   ...
   // if ($stmt->execute()) {
      //  echo "Record inserted successfully.";
        //$URL = "https://mesh001.000webhostapp.com/event.php";
